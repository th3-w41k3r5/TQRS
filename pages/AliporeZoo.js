...
export default function AliporeZoo() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-poppins p-6">
      <div className="bg-white p-6 shadow-md rounded-md">
        <img src="/images/alipore-zoo.jpg" alt="Alipore Zoo" className="w-full h-64 object-cover rounded-md" />
        <h1 className="text-2xl font-bold mt-4">Alipore Zoo</h1>
        <p className="mt-2">Experience the best of wildlife with a visit to Alipore Zoo.</p>
        <p className="mt-2"><strong>Timing:</strong> 9 AM - 5 PM</p>
        <p className="mt-2"><strong>Entry Fee:</strong> Rs 50 per person</p>
        <button
