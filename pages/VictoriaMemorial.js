...
export default function VictoriaMemorial() {
  ...
  const handleBookTicket = () => {
    if (session) {
      router.push("/VictoriaMemorial/book");
    } else {
      setShowModal(true);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-poppins p-6">
      <div className="bg-white p-6 shadow-md rounded-md">
        <img src="/images/victoria-memorial.jpg" alt="Victoria Memorial" className="w-full h-64 object-cover rounded-md" />
        <h1 className="text-2xl font-bold mt-4">Victoria Memorial</h1>
        <p className="mt-2">The Victoria Memorial palace will make you feel the colonial touch in its grand architecture.</p>
        <p className="mt-2"><strong>Timing:</strong> 5 AM - 6:15 PM</p>
        <p className="mt-2"><strong>Entry Fee:</strong> Rs 20 per person</p>
        <button
